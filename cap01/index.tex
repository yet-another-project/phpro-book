...
\begin{itemize}
	\begin{item} \engl[interfață grafică]{graphical user interface}\footnote{\url{http://en.wikipedia.org/wiki/Graphical_user_interface}}
                \abbrev{GUI}{Graphical User Interface}
                \important{Graphical User Interface}
	\begin{description}
	...
	\begin{item}
    \engl[linia de comandă]{command line interface}\footnote{\url{http://en.wikipedia.org/wiki/Command-line_interface}}
    \abbrev{CLI}{Command Line Interface}
    \important{Command Line Interface}
	\begin{description}
