...
Rețelistica (en. \textsl{networking}\index{en-ro}{networking}
\index{term}{rețelistică!networking}) se ocupă cu comunicarea între așa-zise
noduri (en. \textsl{nodes}\index{en-ro}{node} \index{term}{nod!node}). Un nod
poate fi un calculator personal, un \textsl{router}, un \textsl{server},
...
\index{en-ro}{operating system}\index{term}{sistem de operare!operating system}
operare\footnote{en. \textsl{Operating System}, abv. \textsl{OS}}:

\begin{itemize}

    \begin{item}
    interfața grafică (en. \textsl{Graphical User Interface}
    ...
    \begin{item}
    linia de comandă (en \textsl{command Line Interface}
...
\index{term}{MS-DOS Prompt}. Pentru a-l lansa în execuție, este necesară
...
\index{term}{consolă|see{terminal}}\index{term}{terminal} sau
\textsl{shell}\index{term}{shell} (unul dintre ele fiind
\textsl{bash}\index{term}{bash}).
