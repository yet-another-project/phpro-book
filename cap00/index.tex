...
{RSS,\index{abv}{RSS|see{Rich Site Summary}}\index{term}{RSS}\index{term}{Rich Site Summary}\index{en-ro}{Rich Site Summary}
Atom},
...
\good{Nu este recomandată copierea pur și simplă a exemplelor din carte,
    deoarece există riscul de a apare ulteriot incapacitatea de a scrie ceva de
