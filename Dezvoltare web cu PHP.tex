...
%for flow chars
%\usepackage{tikz}
%%%%%\usetikzlibrary{shapes,arrows,positioning,chain}
%side captions
%\usepackage{sidecap}
\usepackage{thumbpdf}
...
\def \phpro{\href{http://phpro.yet-another-project.com/}{phpro}}
...
\include{cap01/index}
%php I - variabile, controlul fluxului de executie, input formulare GET
\include{cap02/index}
%php II - functii, modularizare, separare, securitate, practic: guestbook
%TODO Instead of assuming things are secure until proven otherwise, assume things are INSECURE, because eventually, they are
\include{cap03/index}
%php III baze de date, mysql
%include{cap04/index}
%php IV - OOP
%\include{cap05/index}
%php V - ajax, json, xml, curl, alte extensii
