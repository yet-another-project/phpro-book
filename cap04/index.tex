...
Este suficientă respectarea primelor trei forme normale în aplicaţiile
fără necesităţi speciale.
...
fluxul de execuţie afişând \texttt{\_\_FILE\_\_} şi \texttt{\_\_LINE\_\_}
şi fluxul de date afişând valorile variabilelor cu \texttt{var\_dump()}.

După ce ai terminat de inspectat ce se întâmplă în secvenţa de cod cu probleme,
a trebuit să ştergi apelurile la funcţiile acestea de "debugging".

Pentru a nu mai fi nevoie de aceste adăugiri şi ştergeri de cod temporar,
poţi folosi un debugger. Unul din ele este \textsl{xdebug} şi poate
fi adăugat în PHP ca extensie.

Pentru a-l putea folosi uşor, instalează-ţi şi
\textsl{IDE}-ul\footnote{\url{http://en.wikipedia.org/wiki/Integrated_development_environment}}
Netbeans, iar pentru a porni uşor o nouă sesiune de debugging în firefox,
